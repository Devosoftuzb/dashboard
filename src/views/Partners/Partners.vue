              ...
              <div class="grid font-medium gap-4 mb-4 grid-cols-1">
                <div>
                  ...
                  <h1
                    ...
                    :class="navbar.userNav ? 'text-white' : 'text-black'"
                  >
                    Siz hamkorni o'chirishni xohlaysizmi?
                  </h1>
                </div>
                <div
                  class="w-full flex items-center justify-between border-t pt-5 mt-5"
      ...
      <section class="pt-4" :class="{ 'text-white': navbar.userNav }">
        ...
        <div class="w-full max-w-screen">
          ...
          >
            ...
            >
              <h1 class="text-blue-700 font-bold text-lg">Hamkorlar</h1>
              <div
              ...
              >
                ...
                >
                  <span class="sm:block hidden">Hamkor qo'shish</span>
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td class="text-center font-medium  px-5 py-2">
                      <img class="ham__foto" :src="i.image" alt="">
                    </td>
                    <td class="text-center font-medium  px-5 py-2">
                     {{ i.name }}
                    </td>
