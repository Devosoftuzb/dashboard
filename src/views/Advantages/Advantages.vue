            ...
            >
              <div class="grid font-medium gap-4 mb-4">
                ...
                <div class="flex items-center justify-between gap-5">
                    <div class="w-full">
                  <label for="password" class="block mb-2 text-sm">Icon</label>
                  <input
                    type="text"
                    name="password"
                    id="password"
                ...
                <div>
                    ...
                    <textarea name="" id="more" cols="30" rows="10" class="w-full rounded-lg p-5 border border-gray-300" placeholder="Batafsil.."></textarea>
                </div>
              </div>
              <div
          ...
          >
            ...
            >
              <div class="grid font-medium gap-4 mb-4">
                <div class="flex items-center justify-between gap-5">
                    <div class="w-full">
                  <label for="icon" class="block mb-2 text-sm">Icon</label>
                  <input
                    type="text"
                    name="icon"
                    id="icon"
              ...
              <div class="grid font-medium gap-4 mb-4 grid-cols-1">
                <div>
                  ...
                  <h1
                    ...
                    :class="navbar.userNav ? 'text-white' : 'text-black'"
                  >
                    Siz afzallikkni o'chirishni xohlaysizmi?
                  </h1>
                </div>
                <div
                  class="w-full flex items-center justify-between border-t pt-5 mt-5"
      ...
      <section class="pt-4" :class="{ 'text-white': navbar.userNav }">
        ...
        <div class="w-full max-w-screen">
          ...
          >
            ...
            >
              <h1 class="text-blue-700 font-bold text-lg">Afzalliklar</h1>
              <div
              ...
              >
                ...
                >
                  <span class="sm:block hidden">Afzallik qo'shish</span>
            ...
            <div class="overflow-x-auto">
              <table class="w-full text-sm text-left">
                ...
                >
                    ...
                    <th scope="col" class="text-center py-3">Added Date</th>
