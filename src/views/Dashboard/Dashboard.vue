  ...
  <section :class="{ 'text-white': navbar.userNav }">
    <div class="rounded-lg pt-4">
      ...
      <div class="flex lg:flex-row flex-col gap-4 px-2 pb-4 items-center">
        ...
        >
          <UsersChart class="w-[90%] sm:h-[24rem] h-[16rem] mx-auto" />
        </div>
      </div>
          ...
          <table class="w-full text-sm text-left">
            ...
            >
              <tr>
                ...
                <th scope="col" class="px-6 py-3">Precentage</th>
            ...
            <tbody>
              <tr
                ...
                :class="{
                  'bg-[#222E3C] text-white hover:bg-gray-700': navbar.userNav,
                  'bg-white': !navbar.userNav,
                }"
              >
                <td class="w-4 p-4">
          ...
          <table class="w-full text-sm text-left text-gray-500">
            <tbody>
              <tr
                ...
                :class="{
                  'bg-[#222E3C] hover:bg-gray-700 text-white': navbar.userNav,
                  'bg-white': !navbar.userNav,
                }"
              >
                <th
